...
```javascript
stdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-stdev@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-stdev/tags). For example,

```javascript
stdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-stdev@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var stdev = require( 'path/to/vendor/umd/stats-strided-stdev/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-stdev.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-stdev

[test-image]: https://github.com/stdlib-js/stats-strided-stdev/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-stdev/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-stdev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-stdev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-stdev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-stdev/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-stdev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-stdev/main/LICENSE
